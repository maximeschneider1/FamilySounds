...
class SusiVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        do {
            let audioPath1 = Bundle.main.path(forResource: "Susi Oupsi", ofType: "mp3")
            
            try player1 = AVAudioPlayer(contentsOf: NSURL(fileURLWithPath: audioPath1!) as URL)
        } catch {
            print("error within SusiVC AudioPath")
        }
    ...
    @IBAction func oupsi_Tapped(_ sender: Any) {
    player1.play()
    }
